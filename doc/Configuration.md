# Configuration Guide <br/> Files Microservice

Files microservice configuration structure follows the 
...
Example:
```yaml
- descriptor: "service-files:persistence:memory:default:1.0"
  options:
    max_page_size: 100
```
